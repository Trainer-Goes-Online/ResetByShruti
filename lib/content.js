...
export const VIDEOS = [
  { id: 'v1', envKey: 'VIDEO_1', name: 'Shirley', gap: 'which client · Q13.1' },
  { id: 'v2', envKey: 'VIDEO_2', name: 'Hima', gap: 'which client · Q13.1' },
  { id: 'v3', envKey: 'VIDEO_3', name: 'Arya', gap: 'which client · Q13.1' },
];
